...
public class TestWidget extends gUnitBaseTest {
	...
	public void testWidget4() throws Exception {
		...
		Object retval = execParser("widget", 18, "[plugin:widget { test: \"ok\" } /]", false);
		Object actual = examineExecResult(org.antlr.gunit.gUnitParser.AST, retval);
		Object expecting = "(plugin widget (test \"ok\"))";
	...
	public void testWidget9() throws Exception {
		...
		Object retval = execParser("widget", 33, "[plugin:widget { test: true, other: false } /]", false);
		Object actual = examineExecResult(org.antlr.gunit.gUnitParser.AST, retval);
		Object expecting = "(plugin widget (test true) (other false))";
	...
	public void testWidget10() throws Exception {
		...
		Object retval = execParser("widget", 36, "[plugin:widget]testing[/]", false);
		Object actual = examineExecResult(org.antlr.gunit.gUnitParser.AST, retval);
	...
	public void testWidget11() throws Exception {
		...
		Object retval = execParser("widget", 39, "[plugin:widget { test: true }]testing[/]", false);
		Object actual = examineExecResult(org.antlr.gunit.gUnitParser.AST, retval);
	...
	public void testWidget12() throws Exception {
		// gunit test on line 42
		Object retval = execParser("widget", 42, "[plugin:widget { test: true }][plugin:widget/][/]", false);
		Object actual = examineExecResult(org.antlr.gunit.gUnitParser.AST, retval);
